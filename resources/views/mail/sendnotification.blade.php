...
<img style="margin-left: 25px; margin-bottom: -10px; height: 40px; float: left;" src="https://vt.pinnaclecare.com/assets/img/email/pc1.png" />
...
<div style="width: 550px; margin: 0px auto; background-color: #fff;padding: 25px 25px 45px 25px; margin-top:-1px">
	...
	@foreach($notifications as $notification)
		<div style="margin-top:30px;border: solid #e6e6e6 1px; padding: 25px;background-color: #fafafa;">
			...
			<div style="font-size:13px;  ">{{ substr($notification->vaccine_url->site_message, 0, 255) }} </div>
			<div style="clear:both; height:10px;"></div>
			...
			<button style="background-color: #14b46c;border: none; height:30px; width: 150px;color: #fff;"><a href="{{$notification->vaccine_url->url_registration}}" style="text-decoration: none;color: #fff;">Registration Link</a></button>
		</div>
	@endforeach
</div>
